...
import { CN_MONTHS, getShichenFromTime, getZiShiInfo, calcTrueSolarTime } from '@/lib/constants';
...
function getShiShen(dayStem, targetStem) {
  return shiShenMap[dayStem + targetStem] || '比肩';
}

/* 基于十神的流月运势详解 */
const monthlyShiShenAdvice = {
  比肩: {
    strong: {
      level: 'careful',
      keyword: '竞争与消耗',
      career: '同行竞争加剧，容易陷入"内卷"，需要差异化策略突围。避免在同一赛道硬拼，寻找新切入点。',
      love: '感情上容易出现第三者或竞争关系，需要明确底线。已有对象注意维护安全感，单身者社交圈虽广但真心难辨。',
      wealth: '财务上注意分散风险，不适合大额合作投资。同辈间的金钱往来容易产生纠纷，借贷需谨慎。',
      health: '精力被人际消耗，注意免疫力下降。适当减少社交，给自己留独处恢复的时间。',
      resolve: '佩戴冷色调配饰，减少无效社交，聚焦自己的核心价值。'
    },
    weak: {
      level: 'strong',
      keyword: '助力与合作',
      career: '贵人运旺，同辈朋友会带来关键信息和机会。适合组队合作、联合推进项目。',
      love: '社交场合容易认识志同道合的人，通过朋友介绍的缘分质量较高。',
      wealth: '合作带来收益，适合参与团队项目或合伙经营。',
      health: '精力充沛，适合团队运动，与朋友互相督促养成好习惯。',
      resolve: '主动拓展社交圈，多参加行业交流活动。'
    }
  },
  劫财: {
    strong: {
      level: 'careful',
      keyword: '争夺与破耗',
      career: '团队中容易出现利益争夺或被人抢功。重要方案不要过早曝光，关键决策独立完成。',
      love: '伴侣间容易因金钱或第三方介入产生矛盾。控制情绪，不要在冲动时做重大感情决定。',
      wealth: '本月是破财高危期，避免投机行为和冲动消费。朋友借钱要三思，有借无还的概率较大。',
      health: '情绪波动大，容易失眠或暴饮暴食。需要稳定的作息来对冲内心的焦躁。',
      resolve: '减少与人争论，低调行事。重要财物妥善保管，不参与赌博性投资。'
    },
    weak: {
      level: 'steady',
      keyword: '魄力与突破',
      career: '行动力被激发，适合去争取那些之前犹豫不决的机会。竞争感反而能激发你的潜力。',
      love: '感情上需要更主动，被动等待会错过缘分。表达清晰比暗示更有效。',
      wealth: '在竞争中把握机会，适合谈判和争取更好的条件。但仍需控制非理性支出。',
      health: '能量提升但消耗也大，注意劳逸结合，补充蛋白质和维生素。',
      resolve: '化被动为主动，用竞争激发自我潜能，但控制好"度"。'
    }
  },
  食神: {
    strong: {
      level: 'steady',
      keyword: '表达与享受',
      career: '创造力旺盛，适合内容输出、方案策划、艺术创作。但要注意别光想不做，把灵感落地才是关键。',
      love: '社交魅力值飙升，你的幽默和才华是最好的吸引力。适合约会、浪漫互动。',
      wealth: '通过才华变现的好时机，适合发展副业、知识付费。日常消费容易偏高，注意预算。',
      health: '胃口好、心情佳，但容易放纵饮食。适量运动，别让"享受生活"变成"放纵生活"。',
      resolve: '把创意和灵感记录下来，选最有价值的1-2个去执行。'
    },
    weak: {
      level: 'strong',
      keyword: '才华绽放',
      career: '表达能力达到巅峰，适合做展示、演讲、发布作品。你说的每一句话都比平时更有穿透力。',
      love: '你的温柔和体贴在本月格外打动人心。单身者桃花旺，有伴者感情升温。',
      wealth: '以才生财，通过自己的才华和技能直接获得回报。是接单、签约的好时机。',
      health: '身心放松，免疫力提升。适合尝试新的养生方式或美食体验。',
      resolve: '大胆展示自己，不要藏拙。你此刻的魅力值就是你最好的名片。'
    }
  },
  伤官: {
    strong: {
      level: 'careful',
      keyword: '锋芒与冲突',
      career: '思维锋利但容易得罪人，尤其注意与上级和权威的关系。话到嘴边留三分，方案再好也要选对时机说。',
      love: '挑剔指数满格，伴侣的小毛病在你眼里会被无限放大。管住嘴，别把"为你好"变成人身攻击。',
      wealth: '容易因为不服气而做出冲动投资或消费。头脑发热时不碰钱，冷静24小时再说。',
      health: '情绪过激容易引发头痛、口腔问题或皮肤过敏。需要找到情绪出口：写日记、运动、冥想。',
      resolve: '把锋芒转化为创造力，多写、多画、多做。创作是最好的伤官出口。'
    },
    weak: {
      level: 'steady',
      keyword: '叛逆与创新',
      career: '不走寻常路反而是你的优势。适合提出颠覆性的想法，打破常规的方案本月最容易被采纳。',
      love: '感情中需要新鲜感，可以尝试新的约会方式或共同体验。沟通时多用"我感觉"代替"你应该"。',
      wealth: '创新思维带来独特的赚钱机会，但别太特立独行到脱离市场。',
      health: '精神亢奋，睡眠质量可能下降。睡前远离手机，做些放松练习。',
      resolve: '用创新解决问题，但在人际中保持基本的尊重和分寸。'
    }
  },
  偏财: {
    strong: {
      level: 'strong',
      keyword: '横财与机遇',
      career: '异业合作、跨界机会增多。适合拓展新客户、新市场。人脉就是钱脉，多出去走动。',
      love: '社交场合桃花旺，但容易是"过客型"缘分。享受过程但不要太快投入。',
      wealth: '偏财运强，适合投资、理财、商业合作。但只动用你能承受损失的部分资金。',
      health: '应酬多导致作息不规律，注意肝胆和肠胃保养。少喝酒，多喝水。',
      resolve: '抓住意外之财的机会，但设好止盈止损线。不贪就是最好的保护。'
    },
    weak: {
      level: 'strong',
      keyword: '资源流入',
      career: '意想不到的资源和机会会主动找上门，保持开放心态。有人找你合作，认真评估后不要轻易拒绝。',
      love: '容易遇到经济条件好或社会资源丰富的异性，但需要分辨对方的真实意图。',
      wealth: '进财渠道增多，适合多元化经营。把握住每一个"小机会"，它们会汇聚成大收益。',
      health: '心情愉悦带来正向循环，适合户外活动和社交运动。',
      resolve: '扩大信息面，多关注跨领域的机会。你的下一桶金可能来自意想不到的方向。'
    }
  },
  正财: {
    strong: {
      level: 'steady',
      keyword: '稳健收入',
      career: '工作量增加但回报稳定，适合按部就班把手头的事情做好。不是冲刺月，是积累月。',
      love: '感情进入务实阶段，适合讨论实际问题（买房、规划未来等）。浪漫可以少一点，真诚多一点。',
      wealth: '正财稳定入账，适合存钱、做定期理财。不追求暴利，稳定增长就是最优策略。',
      health: '劳动量偏大，注意腰颈和四肢关节的保养。工作间隙多做拉伸。',
      resolve: '少看别人赚快钱，专注自己的现金流。稳定的正财是所有财富的基石。'
    },
    weak: {
      level: 'strong',
      keyword: '收获回报',
      career: '之前的努力开始变现，薪资调整或业绩奖金的好时机。适合谈加薪、争取更好的待遇。',
      love: '感情中有踏实感，对方的付出让你感到被珍惜。适合确定关系或推进下一步。',
      wealth: '收入增长明显，适合做储蓄和长期投资规划。现在存下的每一分钱都在为未来增值。',
      health: '心态平稳带来身体的放松，免疫力提升。适合做体检和健康管理。',
      resolve: '把收入的30%存起来，用稳定的正财为自己建立安全垫。'
    }
  },
  七杀: {
    strong: {
      level: 'careful',
      keyword: '压力与危机',
      career: '来自上级或外部的压力骤增，可能遇到强势竞争对手或突发困难。但危机中往往藏着转机——如果你能扛住的话。',
      love: '感情上可能遇到控制欲强的人，或者现有关系中出现权力不对等的问题。守住底线，不被PUA。',
      wealth: '财务压力加大，可能有意外支出或被追债。提前做好资金储备，不做任何高杠杆操作。',
      health: '压力导致身体警报频发，注意血压、心脏和睡眠质量。必要时寻求专业帮助。',
      resolve: '用规律的作息和运动对冲压力。记住：能杀你的东西，也能让你变强。'
    },
    weak: {
      level: 'careful',
      keyword: '考验与锤炼',
      career: '本月是高压月，但也是成长最快的月份。来自外界的考验会逼出你的真实实力。咬牙撑过去，你会上一个台阶。',
      love: '感情中可能出现摩擦或冷战。需要勇气去面对问题而不是回避。直面矛盾反而是解决问题的开始。',
      wealth: '开源困难，重点放在节流。减少不必要的开支，保住核心资金流。',
      health: '身心疲惫感明显，特别注意免疫力和情绪管理。睡眠不好的话尝试泡脚和冥想。',
      resolve: '降低期望值，把目标从"赢"调整为"不输"。防守也是一种策略。'
    }
  },
  正官: {
    strong: {
      level: 'steady',
      keyword: '规则与约束',
      career: '适合走正规路线，按流程办事反而效率最高。可能收到来自权威的认可或晋升机会，但附带更多责任。',
      love: '感情中安全感增强，适合正式确定关系或见家长。正官月的缘分往往更靠谱。',
      wealth: '收入稳定但不会有意外之财。遵守财务纪律，不逾矩就不会出错。',
      health: '规律作息是本月的健康密码。按时吃饭、按时睡觉，身体会给你正向反馈。',
      resolve: '顺应规则而非对抗规则，用"靠谱"建立信任资本。'
    },
    weak: {
      level: 'strong',
      keyword: '贵人与提拔',
      career: '权威人士对你的关注度提升，有被赏识和提拔的机会。表现出你的专业性和可靠性，贵人自然来。',
      love: '可能通过工作或正式场合认识条件不错的异性。正官带来的缘分往往品质较高。',
      wealth: '通过正当途径获得稳定收益，适合争取加薪或签署长期合同。',
      health: '身体状态平稳，适合做规律性的健康管理计划。',
      resolve: '穿着得体、言行稳重。本月你的"形象"就是你最大的资产。'
    }
  },
  偏印: {
    strong: {
      level: 'careful',
      keyword: '孤独与偏执',
      career: '容易钻牛角尖，想法多但落地难。注意不要过度思考而耽误行动。如果团队有人给你建议，先听完再反驳。',
      love: '情绪敏感、容易多想。伴侣一句无心的话可能被你解读出十种含义。学会"就事论事"。',
      wealth: '容易被非主流投资吸引（加密货币、小众理财等），冲动跟风概率高。不懂的东西不碰。',
      health: '精神内耗严重，可能出现失眠、偏头痛。需要接地气的活动：散步、做饭、整理房间。',
      resolve: '离开电脑，走到人群中去。与人交流是打破偏印内耗最好的方式。'
    },
    weak: {
      level: 'steady',
      keyword: '灵感与领悟',
      career: '直觉力和学习力提升，适合钻研新技能、考证、做深度学习。可能在某个领域突然"开窍"。',
      love: '精神世界丰富，适合与伴侣做深度交流。分享你的想法和感受，能拉近心理距离。',
      wealth: '偏门知识可能带来偏门收入。关注新兴领域，你的信息嗅觉比平时更灵敏。',
      health: '适合做冥想、瑜伽等静态练习。内在的平静是外在健康的根基。',
      resolve: '把脑子里的想法写下来，整理成可执行的计划。灵感不落地就只是空想。'
    }
  },
  正印: {
    strong: {
      level: 'steady',
      keyword: '学习与保守',
      career: '适合学习充电、考取证书、做知识储备。但要注意不要陷入"永远在准备"的陷阱，学以致用才是目的。',
      love: '你会更关注精神层面的契合，物质条件暂时退居其次。适合一起看书、看展、做文化类约会。',
      wealth: '收入平稳，不适合激进投资。把钱花在提升自己上是本月最佳的"投资"。',
      health: '母亲或长辈的关怀是本月的治愈力量。有空多陪伴家人，你会获得意想不到的能量补充。',
      resolve: '制定一个短期学习计划，用"输入"为下一阶段的"输出"做准备。'
    },
    weak: {
      level: 'strong',
      keyword: '贵人庇护',
      career: '来自长辈、前辈或导师的帮助特别明显。有人愿意把经验和资源分享给你，虚心接受是最好的策略。',
      love: '可能通过长辈介绍认识适合的对象，或者在学习场景中遇到投缘的人。',
      wealth: '可能获得奖金、补贴或意外的资助。知识变现的好时机，你学过的东西开始产生价值。',
      health: '身心状态舒适，保持规律生活即可。适合做体检和长期健康规划。',
      resolve: '主动向值得信任的前辈请教。一次好的指点可能抵过你半年的摸索。'
    }
  }
};

/* 中文月份对应 */
const cnMonthNames = ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];

/* 2026 丙午年流月运势（基于十神关系的个性化分析） */
function generate2026MonthlyFortune(dayStem, dayElement, isStrong, useGod, avoidGod, focus, eightChar, gender) {
  // 利用 EightChar 的大运/流年/流月系统获取精确流月干支
  ...
  for (const daYun of daYunList) {
    ...
    for (const liuNian of liuNianList) {
      if (liuNian.getYear() === 2026) {
        liuYueList = liuNian.getLiuYue();
        break;
      }
    }
    if (liuYueList) break;
  ...
  // 如果没找到（用户年龄太小等），使用手动计算的流月干支
  const fallbackMonthGZ = [
    '庚寅', '辛卯', '壬辰', '癸巳', '甲午', '乙未',
    '丙申', '丁酉', '戊戌', '己亥', '庚子', '辛丑'
  ];

  const focusMap = {
    '事业': 'career', '感情': 'love', '财运': 'wealth', '学业': 'career', '健康': 'health'
  };
  const focusKey = focusMap[focus] || 'career';

  return Array.from({ length: 12 }, (_, idx) => {
    const monthGZ = liuYueList ? liuYueList[idx].getGanZhi() : fallbackMonthGZ[idx];
    const monthStem = monthGZ.charAt(0);
    const monthBranch = monthGZ.charAt(1);
    const monthName = cnMonthNames[idx];

    // 计算流月天干对日主的十神
    const stemShiShen = getShiShen(dayStem, monthStem);
    // 获取流月地支的五行
    const branchElement = branchElementMap[monthBranch] || '土';

    // 获取十神对应的运势详解
    const shiShenData = monthlyShiShenAdvice[stemShiShen] || monthlyShiShenAdvice['比肩'];
    const strengthKey = isStrong ? 'strong' : 'weak';
    const monthAdvice = shiShenData[strengthKey];

    // 根据关注方向获取对应运势
    const focusAdvice = monthAdvice[focusKey] || monthAdvice.career;
    const resolveAdvice = monthAdvice.resolve;

    // 综合评估用神忌神影响
    const monthStemElement = stemElementMap[monthStem] || '土';
    const hasUseGod = monthStemElement === useGod || branchElement === useGod;
    const hasAvoidGod = monthStemElement === avoidGod || branchElement === avoidGod;

    let adjustedLevel = monthAdvice.level;
    if (hasUseGod && !hasAvoidGod && adjustedLevel === 'careful') adjustedLevel = 'steady';
    if (hasAvoidGod && !hasUseGod && adjustedLevel === 'strong') adjustedLevel = 'steady';

    const advice = `${monthName}（${monthGZ}月）· 十神【${stemShiShen}】· ${monthAdvice.keyword}：${focusAdvice} 化解建议：${resolveAdvice}`;

    return {
      month: monthName,
      ganzhi: monthGZ,
      shiShen: stemShiShen,
      keyword: monthAdvice.keyword,
      level: adjustedLevel,
      advice
    };
  });
...
export function computeBaziProfile(data) {
  ...
  const useTrueSolarTime = data.useTrueSolarTime === true || data.useTrueSolarTime === 'true';

  // 真太阳时修正：先获取原始时间，再根据经纬度修正
  let effectiveBirthTime = data.birthTime || '08:30';
  let trueSolarTimeInfo = null;

  // 第一步：先用原始时间创建 Lunar 对象获取阳历日期（用于均时差计算）
  const lunarMonthRaw = toSafeNumber(data.lunarMonth, 1) * (data.isLeapMonth === 'yes' ? -1 : 1);
  const [rawHStr = '8', rawMStr = '30'] = (data.birthTime || '08:30').split(':');
  const rawHour = toSafeNumber(rawHStr, 8);
  const rawMinute = toSafeNumber(rawMStr, 30);
  const lunarRaw = Lunar.fromYmdHms(toSafeNumber(data.lunarYear, 1997), lunarMonthRaw, toSafeNumber(data.lunarDay, 1), rawHour, rawMinute, 0);
  const solarRaw = lunarRaw.getSolar();

  if (useTrueSolarTime && lng) {
    trueSolarTimeInfo = calcTrueSolarTime(
      data.birthTime || '08:30',
      lng,
      solarRaw.getYear(),
      solarRaw.getMonth(),
      solarRaw.getDay()
    );
    effectiveBirthTime = trueSolarTimeInfo.trueSolarTime;
  }

  const [hourString = '8', minuteString = '30'] = effectiveBirthTime.split(':');
  const hour = toSafeNumber(hourString, 8);
  const minute = toSafeNumber(minuteString, 30);
  const shichen = getShichenFromTime(effectiveBirthTime);
  const lunarMonth = toSafeNumber(data.lunarMonth, 1) * (data.isLeapMonth === 'yes' ? -1 : 1);

  // 如果真太阳时修正导致日期偏移，需要调整阳历日期重新获取农历
  let lunar, solar;
  if (useTrueSolarTime && trueSolarTimeInfo && trueSolarTimeInfo.dayShift) {
    // 真太阳时跨日了，通过阳历日期偏移后重新转换
    const shiftedSolar = Solar.fromYmdHms(
      solarRaw.getYear(), solarRaw.getMonth(), solarRaw.getDay() + trueSolarTimeInfo.dayShift,
      hour, minute, 0
    );
    lunar = shiftedSolar.getLunar();
    solar = shiftedSolar;
  } else {
    // 没有跨日或不使用真太阳时
    lunar = Lunar.fromYmdHms(toSafeNumber(data.lunarYear, 1997), lunarMonth, toSafeNumber(data.lunarDay, 1), hour, minute, 0);
  ...
  // 使用 EightChar 类获取精确四柱（自动处理立春换年、节气换月）
  const eightChar = lunar.getEightChar();

  // 子时换日处理（使用真太阳时修正后的时间）
  const ziShiInfo = getZiShiInfo(effectiveBirthTime);
  const ziShiRule = data.ziShiRule || 'change';

  let pillars;
  let ziShiAdjusted = false; // 标记是否进行了子时换日修正

  // 五鼠遁日起时法：根据日干推算子时的天干
  const dayToZiHourStem = {
    '甲': '甲', '己': '甲',
    '乙': '丙', '庚': '丙',
    '丙': '戊', '辛': '戊',
    '丁': '庚', '壬': '庚',
  ...
  if (ziShiInfo.isLateZiShi) {
    // 晚子时（23:00-23:59）需要特殊处理
    // lunar-javascript 传入农历日期+23:xx 时：
    //   日柱 = 当日日柱（不换日），但时柱天干按次日日干算（内部不一致）
    // 所以两种规则都需要手动修正

    if (ziShiRule === 'change') {
      // 「子时统一换日」：23:00后日柱进入次日
      // 通过阳历日期+1来安全获取次日（避免农历月末溢出）
      const solarNextDay = Solar.fromYmdHms(
        solar.getYear(), solar.getMonth(), solar.getDay() + 1,
        0, 30, 0
      );
      const lunarNextDay = solarNextDay.getLunar();
      const eightCharNextDay = lunarNextDay.getEightChar();

      pillars = {
        year: eightChar.getYear(),         // 年柱不变（立春换年，与子时无关）
        month: eightChar.getMonth(),       // 月柱不变（节气换月，与子时无关）
        day: eightCharNextDay.getDay(),    // 使用次日日柱（换日）
        time: eightCharNextDay.getTime()   // 使用次日的时柱（库会正确计算）
      };
      ziShiAdjusted = true;
    } else {
      // 「夜子时不换日」（默认）：23:00-23:59 日柱仍为当日
      // lunar-javascript 传入 23:xx 时日柱已经是当日的，无需改动
      // 但时柱天干被库按次日日干算了，需要用当日日干重新推算
      const currentDayStem = eightChar.getDay().charAt(0);
      const ziHourStem = dayToZiHourStem[currentDayStem] || '甲';

      pillars = {
        year: eightChar.getYear(),
        month: eightChar.getMonth(),
        day: eightChar.getDay(),           // 当日日柱（库默认不换日）
        time: ziHourStem + '子'            // 用当日日干重新推算时柱天干
      };
      ziShiAdjusted = true;
    }
  } else {
  ...
  const monthlyFortune2026 = generate2026MonthlyFortune(dayStem, dayElement, pattern.isStrong, pattern.useGod, pattern.avoidGod, focus, eightChar, gender);
  ...
  // 流月时间轴（基于十神关系重写）
  const timelineShiShenTitles = {
    比肩: { strong: '同行博弈月', weak: '战友协同月' },
    劫财: { strong: '守财低调月', weak: '竞争激活月' },
    食神: { strong: '灵感创作月', weak: '才华绽放月' },
    伤官: { strong: '韬光养晦月', weak: '破旧立新月' },
    偏财: { strong: '横财机遇月', weak: '资源涌入月' },
    正财: { strong: '踏实积累月', weak: '收获回报月' },
    七杀: { strong: '高压应对月', weak: '淬炼成长月' },
    正官: { strong: '按规行事月', weak: '贵人提携月' },
    偏印: { strong: '止损反思月', weak: '灵光开悟月' },
    正印: { strong: '充电蓄力月', weak: '受益良师月' }
  };

  const timelineDirections = {
    比肩: { strong: `适合差异化竞争，避免在${focus}方面与他人硬拼。`, weak: `适合团队协作，在${focus}方面借助同伴力量。` },
    劫财: { strong: `${focus}方面守多攻少，低调处理利益相关事务。`, weak: `把竞争压力转化为动力，在${focus}方面争取突破。` },
    食神: { strong: `创意和表达是本月武器，在${focus}方面大胆展示。`, weak: `才华自带光芒，${focus}方面的产出质量超预期。` },
    伤官: { strong: `管住锋芒，${focus}方面谋定后动、少说多做。`, weak: `打破常规思维，${focus}方面的创新想法值得尝试。` },
    偏财: { strong: `拓展新渠道，${focus}方面的意外机会值得把握。`, weak: `保持开放心态，${focus}方面有资源主动找上门。` },
    正财: { strong: `按部就班，${focus}方面专注做好眼前的事。`, weak: `耕耘开始有回报，${focus}方面的努力被看见。` },
    七杀: { strong: `高压之下稳扎稳打，${focus}方面以防为主。`, weak: `考验是成长的催化剂，${focus}方面突破瓶颈。` },
    正官: { strong: `走正规路线，${focus}方面遵循规则效率最高。`, weak: `权威人士赏识，${focus}方面有贵人相助。` },
    偏印: { strong: `避免钻牛角尖，${focus}方面需要跳出固有思维。`, weak: `灵感和直觉敏锐，${focus}方面深度学习收获大。` },
    正印: { strong: `充电蓄力期，${focus}方面适合学习和积累。`, weak: `长辈/前辈指点迷津，${focus}方面有人带路。` }
  };

  const timeline = monthlyFortune2026.map((mf, index) => {
    const monthNumber = index + 1;
    const shiShen = mf.shiShen;
    const strengthKey = pattern.isStrong ? 'strong' : 'weak';
    const title = (timelineShiShenTitles[shiShen] || timelineShiShenTitles['比肩'])[strengthKey];
    const direction = (timelineDirections[shiShen] || timelineDirections['比肩'])[strengthKey];
    const shiShenData = monthlyShiShenAdvice[shiShen] || monthlyShiShenAdvice['比肩'];
    const adviceData = shiShenData[strengthKey];

    return {
      month: `${monthNumber}月`,
      lunarMonthLabel: `${CN_MONTHS[index]}月`,
      flowYearGanzhi,
      flowMonthGanzhi: mf.ganzhi,
      shiShen: shiShen,
      level: mf.level,
      title,
      advice: `${adviceData.keyword}：${(focusProfile[mf.level] || focusProfile.steady)}`,
      direction,
      summary: `${flowYearGanzhi}年 ${mf.ganzhi}月 · 十神【${shiShen}】· ${focus}方向重点关注。`
    };
  });
  ...
  const solarText = `${solar.getYear()}-${String(solar.getMonth()).padStart(2, '0')}-${String(solar.getDay()).padStart(2, '0')} ${String(solar.getHour()).padStart(2, '0')}:${String(solar.getMinute()).padStart(2, '0')}`;
  const lunarText = `${data.lunarYear}年${data.isLeapMonth === 'yes' ? '闰' : ''}${CN_MONTHS[toSafeNumber(data.lunarMonth, 1) - 1]}月${data.lunarDay}日`;

  // AI Prompt 所需的流月干支列表文本
  const monthlyGanzhiList = monthlyFortune2026.map((mf, idx) => {
    return `${cnMonthNames[idx]}：${mf.ganzhi}（十神：${mf.shiShen}）`;
  }).join('\n');

  // 五行分布文本
  const elementCountText = Object.entries(pattern.elementCount).map(([el, count]) => `${el}:${count}`).join('  ');
  const totalElementCount = Object.values(pattern.elementCount).reduce((a, b) => a + b, 0);

  // 当前日期（浮动，每次请求时实时获取）
  const now = new Date();
  const currentDate = `${now.getFullYear()}年${now.getMonth() + 1}月${now.getDate()}日`;

  // 计算过去5年流年干支与十神（用于 AI 推断 pastYears 板块）
  const pastYearGanzhiList = [];
  for (let y = currentYear - 5; y <= currentYear - 1; y++) {
    const yearSolar = Solar.fromYmd(y, 6, 15);
    const yearLunar = yearSolar.getLunar();
    const yearGZ = yearLunar.getYearInGanZhi();
    const yearStem = yearGZ.charAt(0);
    const yearBranch = yearGZ.charAt(1);
    const yearShiShen = getShiShen(dayStem, yearStem);
    const yearStemElement = stemElementMap[yearStem] || '土';
    const yearBranchElement = branchElementMap[yearBranch] || '土';
    pastYearGanzhiList.push({
      year: y,
      ganzhi: yearGZ,
      shiShen: yearShiShen,
  ...
  const pastYearGanzhiText = pastYearGanzhiList.map(py =>
    `${py.year}年：${py.ganzhi}（天干十神：${py.shiShen}，天干五行属${py.stemElement}，地支五行属${py.branchElement}）`
  ).join('\n');

  // 当前流年信息
  const currentYearStem = flowYearGanzhi.charAt(0);
  const currentYearBranch = flowYearGanzhi.charAt(1);
  const currentYearShiShen = getShiShen(dayStem, currentYearStem);
  const currentYearStemElement = stemElementMap[currentYearStem] || '土';
  const currentYearBranchElement = branchElementMap[currentYearBranch] || '土';
  const currentYearText = `${currentYear}年：${flowYearGanzhi}（天干十神：${currentYearShiShen}，天干五行属${currentYearStemElement}，地支五行属${currentYearBranchElement}）`;

  // AI Prompt 用的原始排盘数据包
  const promptData = {
    gender,
    birthPlace: data.birthPlace || '未填写',
    lunarText,
    solarText,
    birthTime: data.birthTime || '08:30',
    effectiveBirthTime,
    useTrueSolarTime,
    trueSolarTimeDetail: trueSolarTimeInfo ? trueSolarTimeInfo.detail : null,
    shichen,
    focus,
    pillars,
    dayStem,
